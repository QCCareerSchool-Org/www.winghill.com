    ...
    <>
      <section>
        <div className="container">
          <h1 className="text-center mb-5">Your Tutors</h1>
          <div className="row justify-content-center align-items-start">
            <div className="col-md-12 col-lg-6">
              ...
              <h2 className="h3">Here's How It Works</h2>
              <p>When you enroll, the first assignment you'll be asked to complete is a personal profile. This is your chance to introduce yourself to the School and to your tutor. At the School office, we'll carefully study your profile and assign you to the tutor whose skills and interests best match your own. You'll quickly form a close working relationship. Your tutor will tailor personal assignments for you and will give you guidance and feedback as you progress through the course. Step by step, your skills will improve and you will learn to write to professional standards.</p>
            </div>
      ...
      <section className="bg-light">
        <div className="container">
          <div className="row justify-content-center align-items-start g-5">
            <div className="col-md-12 col-lg-6">
              <h2 className="text-center mb-5">Laurie Clayton</h2>
            ...
            <div className="col-md-12 col-lg-6">
              ...
              <p>
                Production assistant and story producer for CBC radio<br />
                Co-creator, Winghill Writing School Screenwriting Course
              </p>
              <h4 className="h5">Selected Screenplays</h4>
              <p>
                &ldquo;The Island of the Child King&rdquo; and &ldquo;Life in Puerto Angel,&rdquo; Skyland, Nine Story, Method Films<br />
      ...
      <section>
        <div className="container text-center">
          <h2 className="text-center mb-5">Maggie Wheeler</h2>
