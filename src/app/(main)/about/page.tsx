    ...
    <>
          ...
          <div className="row justify-content-center g-5">
            {coreValues.map(c => (
              <div key={c.title} className="col-10 col-sm-8 col-md-6 col-lg-4">
                <Image src={c.icon} alt="" className="img-fluid" width="200" />
                <h5>{c.title}</h5>
                {c.text}
              </div>
            ))}
      ...
      <section className="bg-light">
        <div className="container">
          ...
          <div className="row">
            <div className="col-12 col-lg-4 text-center text-start-lg">
              <Image src={Guarantee} alt="money back 100% guarantee" className="img-fluid" width="200" />
            </div>
