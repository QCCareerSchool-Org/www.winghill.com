    ...
    <>
      ...
      <section className="bg-light">
        <div className="container text-center">
          <Image src={YourCourseBeginsIcon} alt="" className="img-fluid" />
          <h2 className="h1 mb-4 text-center">Your Course Begins</h2>
      ...
      <section>
        <div className="container text-center">
          <Image src={AssignmentIcon} alt="" className="img-fluid" />
          <h2 className="h1 mb-4">Work Through Your Assignments</h2>
      ...
      <section className="bg-light">
        <div className="container text-center">
          <Image src={CustomizeIcon} alt="" className="img-fluid" />
          <h2 className="h1 mb-4">Customize & Refine your Course</h2>
          <p>By this time we are beginning to understand you quite well. Your tutor adapts the course to meet your unique needs. Together, you discover your hidden talents and full potential.</p>
        </div>
      </section>

      <section>
        <div className="container text-center">
          <Image src={RefiningYourTechniqueIcon} alt="" className="img-fluid" />
          <h2 className="h1 mb-4">Refining Your Technique</h2>
          <p>Your personal tutor reviews and analyzes each idea, story or article you submit. He or she will help you sharpen both your writing and marketing skills. You build confidence in your abilities as they improve with every unit you complete. By the end of the course, you should have an impressive portfolio of publishable work.</p>
        </div>
      </section>
      ...
      <section>
        <div className="container text-center">
          ...
          <p>Once you've completed all your assignments, we send your certificate to you by courier. You now have the skills and confidence to achieve your writing goals!</p>
          <a href="https://enroll.winghill.com" className="btn btn-primary">Enroll Now</a>
        </div>
      </section>
    </>
  );
