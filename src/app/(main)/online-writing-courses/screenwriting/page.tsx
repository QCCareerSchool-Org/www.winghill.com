  ...
  return (
    <>
        ...
        <div className="container">
          <div className="row justify-content-center align-items-center">
            ...
            <div className="col-12 col-md-10 col-lg-8">
              <h2 className="mb-3">Movie Magic Screenwriter Software</h2>
              ...
              <p className="mb-0">With over 100 templates for writing your story or script, Movie Magic Screenwriter teaches you how to produce works for all sorts of genres and media. And, it's easy to navigate—all you need to learn how to do is hit the tab and enter buttons on your keyboard. It really is that simple, and the results are nothing short of amazing.</p>
            </div>
          </div>
        </div>
      </section>
      <section className="bg-light">
        <div className="container">
          <h2 className="mb-3 text-center">Your Assignments</h2>
          <p className="lead">We have mastered the art of distance education, and our step by step training will teach you everything you need to succeed in the Screenwriting industry! If you're eager to know what you'll learn, take a look at our learning system breakdown:</p>
          ...
          <h3 className="h5">Designing the &quot;Right&quot; Assignments For Your Needs</h3>
          ...
          <h3 className="h5">Analyzing the Market</h3>
          ...
          <h3 className="h5">Developing the Script</h3>
          ...
          <h3 className="h5">The Process Continues</h3>
